...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/ibilechain-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ibilechain-cli.cpp \
           src/ibilechain-tx.cpp \
           src/ibilechain.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/ibilechain.qrc src/qt/ibilechain_locale.qrc

TRANSLATIONS += src/qt/locale/ibilechain_bg.ts \
                src/qt/locale/ibilechain_de.ts \
                src/qt/locale/ibilechain_en.ts \
                src/qt/locale/ibilechain_es.ts \
                src/qt/locale/ibilechain_fi.ts \
                src/qt/locale/ibilechain_fr.ts \
                src/qt/locale/ibilechain_it.ts \
                src/qt/locale/ibilechain_ja.ts \
                src/qt/locale/ibilechain_pl.ts \
                src/qt/locale/ibilechain_pt.ts \
                src/qt/locale/ibilechain_ru.ts \
                src/qt/locale/ibilechain_sk.ts \
                src/qt/locale/ibilechain_sv.ts \
                src/qt/locale/ibilechain_vi.ts \
                src/qt/locale/ibilechain_zh_CN.ts \
                src/qt/locale/ibilechain_zh_TW.ts
