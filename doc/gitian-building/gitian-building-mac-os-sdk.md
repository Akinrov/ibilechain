...
The script [extract-osx-sdk.sh](https://github.com/ibilechain-project/ibilechain/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ibilechain/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ibilechain-project/ibilechain/blob/master/doc/README_osx.md) for troubleshooting tips.