...
class ReorgStakeTest(IbilechainTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected IBLC supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check IBLC supply at the beginning
        # ------------------------------------------
        # IBLC supply: block rewards minus burned fees for minting
        ...
        # Verify that IBLC supplies were properly updated after the spends and reorgs
        self.log.info("Check IBLC supply...")
