...
"""Verify that starting ibilechain with -h works as expected."""
import subprocess

from test_framework.test_framework import IbilechainTestFramework
from test_framework.util import assert_equal

class HelpTest(IbilechainTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ibilechain with -? for help text")
        ...
        self.log.info("Start ibilechain with -version for version information")
