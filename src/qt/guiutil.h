...
/** Utility functions used by the Ibilechain Qt UI.
 */
namespace GUIUtil
{
...
// Render IBLC addresses in monospace font
...
// Parse "ibilechain:" URI into recipient object, return true on successful parsing
