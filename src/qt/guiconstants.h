...
/* Ibilechain GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ibilechain"
#define QAPP_ORG_DOMAIN "ibilechain.org"
#define QAPP_APP_NAME_DEFAULT "Ibilechain-Qt"
#define QAPP_APP_NAME_TESTNET "Ibilechain-Qt-testnet"
