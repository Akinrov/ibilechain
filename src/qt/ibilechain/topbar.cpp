...
#include "qt/ibilechain/forms/ui_topbar.h"
#include "qt/ibilechain/loadingdialog.h"
#include "qt/ibilechain/lockunlock.h"
#include "qt/ibilechain/qtutils.h"
#include "qt/ibilechain/receivedialog.h"
                                                        ...
                                                        ui(new Ui::TopBar)
{
    ...
    ui->pushButtonConf->setButtonText("ibilechain.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open ibilechain.conf with default application"));
}
