...
#include "qt/ibilechain/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ibilechain/settings/moc_settingsconsolewidget.cpp"
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the IBLC RPC console.") + "<br>" +
