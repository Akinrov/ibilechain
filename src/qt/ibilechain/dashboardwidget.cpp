...
#include "qt/ibilechain/forms/ui_dashboardwidget.h"
#include "qt/ibilechain/sendconfirmdialog.h"
#include "qt/ibilechain/txrow.h"
    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of IBLC earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 IBLC");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("IBLC")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair IBLC
