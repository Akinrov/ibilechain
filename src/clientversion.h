...
#error Client version information missing: version is not defined by ibilechain-config.h or in any other way
#endif
...
/**
 * ibilechaind-res.rc includes this file, but it cannot cope with real c++ code.
