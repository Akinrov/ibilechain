...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Ibilechain server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Ibilechain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* IBLC features */
        {"ibilechain", "listmasternodes", &listmasternodes, true },
        {"ibilechain", "getmasternodecount", &getmasternodecount, true },
        {"ibilechain", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"ibilechain", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"ibilechain", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"ibilechain", "masternodecurrent", &masternodecurrent, true },
        {"ibilechain", "startmasternode", &startmasternode, true },
        {"ibilechain", "createmasternodekey", &createmasternodekey, true },
        {"ibilechain", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"ibilechain", "listmasternodeconf", &listmasternodeconf, true },
        {"ibilechain", "getactivemasternodecount", &getactivemasternodecount, true },
        {"ibilechain", "getmasternodestatus", &getmasternodestatus, true },
        {"ibilechain", "getmasternodewinners", &getmasternodewinners, true },
        {"ibilechain", "getmasternodescores", &getmasternodescores, true },
        {"ibilechain", "mnsync", &mnsync, true },
        {"ibilechain", "spork", &spork, true },
...
{
    return "> ibilechain-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3423/\n";
}
