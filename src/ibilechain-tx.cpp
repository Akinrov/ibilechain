...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ibilechain ibilechain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ibilechain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ibilechain transaction") + "\n" +
                               "  ibilechain-tx [options] -create [commands]   " + _("Create hex-encoded ibilechain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ibilechain transaction
