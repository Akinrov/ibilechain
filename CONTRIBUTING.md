Contributing to Ibilechain Core
============================

The Ibilechain Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ibilechain-project/ibilechain/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Ibilechain Core project, and is not to be
confused with overall Ibilechain Network Protocol consensus changes.

Whether a pull request is merged into Ibilechain Core rests with the project merge
...
Patches that change Ibilechain consensus rules are considerably more involved than
...
Where a patchset proposes to change the Ibilechain consensus, it must have been
...
The project leader is the release manager for each Ibilechain Core release.
